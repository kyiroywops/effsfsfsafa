...
class AppColors {
  ...
  static const Color menuBackground = Colors.white;
  static const Color itemsBackground = Colors.white;
  static const Color pageBackground = Colors.white;
  static const Color mainTextColor1 = Colors.white;
  static const Color mainTextColor2 = Colors.white70;
  static const Color mainTextColor3 = Colors.white;
  static const Color mainGridLineColor = Colors.white10;
  static const Color borderColor = Colors.white;
  static const Color gridLinesColor = Colors.white;
...
class LineChart1 extends StatelessWidget {
  ...
  FlBorderData get borderData => FlBorderData(
        ...
        border: Border(
          bottom:
              BorderSide(color: AppColors.primary.withOpacity(0.9), width: 4),
